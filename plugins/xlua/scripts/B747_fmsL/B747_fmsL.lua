...
function B747_fms1_display_navrad()
        ...
        B747DR_fms1_Line02_L = string.format("1                       ", "")
        B747DR_fms1_Line03_L = string.format(" 2                      ", "")
        B747DR_fms1_Line04_L = string.format("  3                     ", "")
        B747DR_fms1_Line05_L = string.format("   4                    ", "")
        B747DR_fms1_Line06_L = string.format("    5                    ", "")
        B747DR_fms1_Line07_L = string.format("     6                   ", "")
        B747DR_fms1_Line08_L = string.format("      7                  ", "")
        B747DR_fms1_Line09_L = string.format("       8                 ", "")
        B747DR_fms1_Line10_L = string.format("        9                ", "")
        B747DR_fms1_Line11_L = string.format("         10               ", "")
        B747DR_fms1_Line12_L = string.format("          11              ", "")
        B747DR_fms1_Line13_L = string.format("           12             ", "")
        B747DR_fms1_Line14_L = string.format("            13            ", "")

        B747DR_fms1_Line01_S = string.format("nav                        ", "")
        B747DR_fms1_Line02_S = string.format(" fmcL                       ", "")
        B747DR_fms1_Line03_S = string.format("  fmcC                      ", "")
        B747DR_fms1_Line04_S = string.format("   fmcR                     ", "")
        B747DR_fms1_Line05_S = string.format("                        ", "")
        B747DR_fms1_Line06_S = string.format("                        ", "")
        B747DR_fms1_Line07_S = string.format("                        ", "")
        B747DR_fms1_Line08_S = string.format("                        ", "")
        B747DR_fms1_Line09_S = string.format("                        ", "")
        B747DR_fms1_Line10_S = string.format("                        ", "")
        B747DR_fms1_Line11_S = string.format("                        ", "")
        B747DR_fms1_Line12_S = string.format("                        ", "")
        B747DR_fms1_Line13_S = string.format("                        ", "")
