...
B747DR_init_manip_CD                = create_dataref("laminar/B747/manip/init_CD", "number")

B747DR_button_switch_cover_position = create_dataref("laminar/B747/button_switch_cover/position", "array[" .. tostring(NUM_BTN_SW_COVERS) .. "]")
B747DR_button_switch_position       = create_dataref("laminar/B747/button_switch/position", "array[" .. tostring(NUM_BTN_SW) .. "]")
...
----- COCKPIT ACCESSORY DOOR HANDLE -----------------------------------------------------
B747DR_accy_door_handle             = create_dataref("laminar/B747/misc/accy_door_handle", "number", B747_accy_door_handle_DRhandler)



----- COCKPIT SUN VISORS ----------------------------------------------------------------
B747DR_sun_visor_left_right_capt    = create_dataref("laminar/B747/misc/sun_visor/left_right/capt", "number", B747_sun_visor_left_right_capt_DRhandler)
B747DR_sun_visor_left_right_fo      = create_dataref("laminar/B747/misc/sun_visor/left_right/fo", "number", B747_sun_visor_left_right_fo_DRhandler)


----- OVERHEAD MAP LIGHTS ---------------------------------------------------------------
B747DR_ovhd_map_light_x_capt        = create_dataref("laminar/B747/misc/ovhd_map_light/x_axis/capt", "number", B747_ovhd_map_light_x_capt_DRhandler)
B747DR_ovhd_map_light_y_capt        = create_dataref("laminar/B747/misc/ovhd_map_light/y_axis/capt", "number", B747_ovhd_map_light_y_capt_DRhandler)

B747DR_ovhd_map_light_x_fo          = create_dataref("laminar/B747/misc/ovhd_map_light/x_axis/fo", "number", B747_ovhd_map_light_x_fo_DRhandler)
...
for i = 0, NUM_BTN_SW_COVERS-1 do
    B747CMD_button_switch_cover[i] 		= create_command("laminar/B747/button_switch_cover" .. string.format("%02d", i), "Button Switch Cover" .. string.format("%02d", i), B747_button_switch_cover_CMDhandler[i])
end
...
-- WARNING/CAUTION
B747CMD_warning_caution_captain 		= create_command("laminar/B747/button_switch/warn_caut_capt", "Warning/Caution Reset (Captain)", B747_warning_caution_captain_CMDhandler)
B747CMD_warning_caution_fo 				= create_command("laminar/B747/button_switch/warn_caut_fo", "Warning/Caution Reset (First Officer)", B747_warning_caution_fo_CMDhandler)
...
-- ALTERNATE FLAP
B747CMD_altn_flap 						= create_command("laminar/B747/button_switch/altn_flap", "Alternate Flaps", B747_altn_flap_CMDhandler)

-- ALTERNATE GEAR
B747CMD_altn_nose_gear_extend 			= create_command("laminar/B747/button_switch/altn_nose_gear_extend", "Alternate Nose Gear Extend", B747_altn_nose_gear_extend_CMDhandler)
B747CMD_altn_wing_gear_extend 			= create_command("laminar/B747/button_switch/altn_wing_gear_extend", "Alternate Wing gear Extend", B747_altn_wing_gear_extend_CMDhandler)

-- GROUND PROXIMITY
B747CMD_gnd_prox_gs_inhibit 			= create_command("laminar/B747/button_switch/gnd_prox_gs_inhibit", "Ground Proximity Glideslope Inhibit", B747_gnd_prox_gs_inhibit_CMDhandler)
B747CMD_gnd_prox_flap_ovrd 				= create_command("laminar/B747/button_switch/gnd_prox_flap_ovrd", "Ground Proximity Flap Override", B747_gnd_prox_flap_ovrd_CMDhandler)
B747CMD_gnd_prox_gear_ovrd 				= create_command("laminar/B747/button_switch/gnd_prox_gear_ovrd", "Ground Proximity gear Override", B747_gnd_prox_gear_ovrd_CMDhandler)
B747CMD_gnd_prox_terr_ovrd 				= create_command("laminar/B747/button_switch/gnd_prox_terr_ovrd", "Ground Proximity Terrain Override", B747_gnd_prox_terr_ovrd_CMDhandler)
...
B747CMD_elec_eng_ctrl_1 				= create_command("laminar/B747/button_switch/elec_eng_ctrl_1", "Electronic Engine Control 1", B747_elec_eng_ctrl_1_CMDhandler)
B747CMD_elec_eng_ctrl_2 				= create_command("laminar/B747/button_switch/elec_eng_ctrl_2", "Electronic Engine Control 2", B747_elec_eng_ctrl_2_CMDhandler)
B747CMD_elec_eng_ctrl_3 				= create_command("laminar/B747/button_switch/elec_eng_ctrl_3", "Electronic Engine Control 3", B747_elec_eng_ctrl_3_CMDhandler)
B747CMD_elec_eng_ctrl_4 				= create_command("laminar/B747/button_switch/elec_eng_ctrl_4", "Electronic Engine Control 4", B747_elec_eng_ctrl_4_CMDhandler)

-- ELECTRIC
B747CMD_elec_util_L 					= create_command("laminar/B747/button_switch/elec_util_L", "Utility L", B747_elec_util_L_CMDhandler)
B747CMD_elec_util_R 					= create_command("laminar/B747/button_switch/elec_util_R",  "Utility R", B747_elec_util_R_CMDhandler)
B747CMD_elec_battery 					= create_command("laminar/B747/button_switch/elec_battery", "Battery", B747_elec_battery_CMDhandler)
B747CMD_elec_ext_pwr_1 					= create_command("laminar/B747/button_switch/elec_ext_pwr_1", "External Power 1", B747_elec_ext_pwr_1_CMDhandler)
B747CMD_elec_ext_pwr_2 					= create_command("laminar/B747/button_switch/elec_ext_pwr_2", "External Power 2", B747_elec_ext_pwr_2_CMDhandler)
B747CMD_elec_apu_gen_1 					= create_command("laminar/B747/button_switch/elec_apu_gen_1", "APU Generator 1", B747_elec_apu_gen_1_CMDhandler)
B747CMD_elec_apu_gen_2 					= create_command("laminar/B747/button_switch/elec_apu_gen_2", "APU Generator 2", B747_elec_apu_gen_2_CMDhandler)
B747CMD_elec_bus_tie_1 					= create_command("laminar/B747/button_switch/elec_bus_tie_1", "Bus Tie 1", B747_elec_bus_tie_1_CMDhandler)
B747CMD_elec_bus_tie_2 					= create_command("laminar/B747/button_switch/elec_bus_tie_2", "Bus Tie 2", B747_elec_bus_tie_2_CMDhandler)
B747CMD_elec_bus_tie_3 					= create_command("laminar/B747/button_switch/elec_bus_tie_3", "Bus Tie 3", B747_elec_bus_tie_3_CMDhandler)
B747CMD_elec_bus_tie_4 					= create_command("laminar/B747/button_switch/elec_bus_tie_4", "Bus Tie 4", B747_elec_bus_tie_4_CMDhandler)
B747CMD_elec_gen_ctrl_1 				= create_command("laminar/B747/button_switch/elec_gen_ctrl_1", "Generator Control 1", B747_elec_gen_ctrl_1_CMDhandler)
B747CMD_elec_gen_ctrl_2 				= create_command("laminar/B747/button_switch/elec_gen_ctrl_2", "Generator Control 2", B747_elec_gen_ctrl_2_CMDhandler)
B747CMD_elec_gen_ctrl_3 				= create_command("laminar/B747/button_switch/elec_gen_ctrl_3", "Generator Control 3", B747_elec_gen_ctrl_3_CMDhandler)
B747CMD_elec_gen_ctrl_4 				= create_command("laminar/B747/button_switch/elec_gen_ctrl_4", "Generator Control 4", B747_elec_gen_ctrl_4_CMDhandler)
B747CMD_elec_drive_disc_1 				= create_command("laminar/B747/button_switch/elec_drive_disc_1", "Drive Disc 1", B747_elec_drive_disc_1_CMDhandler)
...
B747CMD_hyd_pump_3 						= create_command("laminar/B747/button_switch/hyd_pump_3", "Hydraulic Pump 3", B747_hyd_pump_3_CMDhandler)
B747CMD_hyd_pump_4 						= create_command("laminar/B747/button_switch/hyd_pump_4", "Hydraulic Pump 4", B747_hyd_pump_4_CMDhandler)

-- PRESSURIZATION
B747CMD_press_outflow_vlv_L 			= create_command("laminar/B747/button_switch/press_outflow_vlv_L", "Pressure Outflow Valve L", B747_press_outflow_vlv_L_CMDhandler)
B747CMD_press_outflow_vlv_R 			= create_command("laminar/B747/button_switch/press_outflow_vlv_R", "Pressure Outflow Valve R", B747_press_outflow_vlv_R_CMDhandler)

-- TEMPERATURE
B747CMD_temp_zone_rst 					= create_command("laminar/B747/button_switch/temp_zone_rst", "Temperature Zone Reset", B747_temp_zone_rst_CMDhandler)
B747CMD_temp_trim_air 					= create_command("laminar/B747/button_switch/temp_trim_air", "Temperture Trim Air", B747_temp_trim_air_CMDhandler)
B747CMD_temp_recirc_upr 				= create_command("laminar/B747/button_switch/temp_recirc_upr", "Temperature Recirculation Upper", B747_temp_recirc_upr_CMDhandler)
B747CMD_temp_recirc_lwr 				= create_command("laminar/B747/button_switch/temp_recirc_lwr", "Temperature Recirculation Lower", B747_temp_recirc_lwr_CMDhandler)
B747CMD_temp_aft_cargo_ht 				= create_command("laminar/B747/button_switch/temp_aft_cargo_ht", "Temperature Cargo Heat", B747_temp_aft_cargo_ht_CMDhandler)
B747CMD_temp_hi_flow 					= create_command("laminar/B747/button_switch/temp_hi_flow", "Temperature Hi Flow", B747_temp_hi_flow_CMDhandler)
B747CMD_temp_pack_rst 					= create_command("laminar/B747/button_switch/temp_pack_rst", "Temperature Pack Reset", B747_temp_pack_rst_CMDhandler)

-- MISC FUEL CONTROL
B747CMD_misc_fuel_xfr_1_4 				= create_command("laminar/B747/button_switch/misc_fuel_xfr_1_4", "Miscellaneous Fuel Tranfer 1 & 4", B747_misc_fuel_xfr_1_4_CMDhandler)

-- START
B747CMD_start_ign_cont 					= create_command("laminar/B747/button_switch/start_ign_cont", "Ignition Continous", B747_start_ign_cont_CMDhandler)
B747CMD_start_autostart 				= create_command("laminar/B747/button_switch/start_autostart", "Autostart", B747_start_autostart_CMDhandler)

-- FUEL JETTISON SYSTEM
B747CMD_fuel_jet_nozzle_vlv_L 			= create_command("laminar/B747/button_switch/fuel_jet_nozzle_vlv_L", "Fuel Jettison Nozzle Valve L", B747_fuel_jet_nozzle_vlv_L_CMDhandler)
B747CMD_fuel_jet_nozzle_vlv_R 			= create_command("laminar/B747/button_switch/fuel_jet_nozzle_vlv_R", "Fuel Jettison Nozzle Valve R", B747_fuel_jet_nozzle_vlv_R_CMDhandler)

-- FUEL SYSTEM
B747CMD_fuel_xfeed_vlv_1 				= create_command("laminar/B747/button_switch/fuel_xfeed_vlv_1", "Fuel Crossfeed Valve 1", B747_fuel_xfeed_vlv_1_CMDhandler)
B747CMD_fuel_xfeed_vlv_2 				= create_command("laminar/B747/button_switch/fuel_xfeed_vlv_2", "Fuel Crossfeed Valve 2", B747_fuel_xfeed_vlv_2_CMDhandler)
B747CMD_fuel_xfeed_vlv_3 				= create_command("laminar/B747/button_switch/fuel_xfeed_vlv_3", "Fuel Crossfeed Valve 3", B747_fuel_xfeed_vlv_3_CMDhandler)
B747CMD_fuel_xfeed_vlv_4 				= create_command("laminar/B747/button_switch/fuel_xfeed_vlv_4", "Fuel Crossfeed Valve 4", B747_fuel_xfeed_vlv_4_CMDhandler)
B747CMD_fuel_ctr_wing_tnk_pump_L 		= create_command("laminar/B747/button_switch/fuel_ctr_wing_tnk_pump_L", "Fuel Center Wing Tank Pump L", B747_fuel_ctr_wing_tnk_pump_L_CMDhandler)
B747CMD_fuel_ctr_wing_tnk_pump_R 		= create_command("laminar/B747/button_switch/fuel_ctr_wing_tnk_pump_R", "Fuel Center Wing Tank Pump R", B747_fuel_ctr_wing_tnk_pump_R_CMDhandler)
B747CMD_fuel_stab_tnk_pump_L 			= create_command("laminar/B747/button_switch/fuel_stab_tnk_pump_L", "Fuel Stabilizer Tank Pump L", B747_fuel_stab_tnk_pump_L_CMDhandler)
B747CMD_fuel_stab_tnk_pump_R 			= create_command("laminar/B747/button_switch/fuel_stab_tnk_pump_R", "Fuel Stabilizer Tank Pump R", B747_fuel_stab_tnk_pump_R_CMDhandler)
B747CMD_fuel_main_pump_fwd_1 			= create_command("laminar/B747/button_switch/fuel_main_pump_fwd_1", "Fuel Main Pump Forward 1", B747_fuel_main_pump_fwd_1_CMDhandler)
B747CMD_fuel_main_pump_fwd_2 			= create_command("laminar/B747/button_switch/fuel_main_pump_fwd_2", "Fuel Main Pump Forward 2", B747_fuel_main_pump_fwd_2_CMDhandler)
B747CMD_fuel_main_pump_fwd_3 			= create_command("laminar/B747/button_switch/fuel_main_pump_fwd_3", "Fuel Main Pump Forward 3", B747_fuel_main_pump_fwd_3_CMDhandler)
B747CMD_fuel_main_pump_fwd_4 			= create_command("laminar/B747/button_switch/fuel_main_pump_fwd_4", "Fuel Main Pump Forward 4", B747_fuel_main_pump_fwd_4_CMDhandler)
B747CMD_fuel_main_pump_aft_1 			= create_command("laminar/B747/button_switch/fuel_main_pump_aft_1", "Fuel Main Pump Aft 1", B747_fuel_main_pump_aft_1_CMDhandler)
B747CMD_fuel_main_pump_aft_2 			= create_command("laminar/B747/button_switch/fuel_main_pump_aft_2", "Fuel Main Pump Aft 2", B747_fuel_main_pump_aft_2_CMDhandler)
B747CMD_fuel_main_pump_aft_3 			= create_command("laminar/B747/button_switch/fuel_main_pump_aft_3", "Fuel Main Pump Aft 3", B747_fuel_main_pump_aft_3_CMDhandler)
B747CMD_fuel_main_pump_aft_4 			= create_command("laminar/B747/button_switch/fuel_main_pump_aft_4", "Fuel Main Pump Aft 4", B747_fuel_main_pump_aft_4_CMDhandler)
B747CMD_fuel_overd_pump_fwd_2 			= create_command("laminar/B747/button_switch/fuel_overd_pump_fwd_2", "Fuel Override Pump Forward 2", B747_fuel_overd_pump_fwd_2_CMDhandler)
B747CMD_fuel_overd_pump_fwd_3 			= create_command("laminar/B747/button_switch/fuel_overd_pump_fwd_3", "Fuel Override Pump Forward 3", B747_fuel_overd_pump_fwd_3_CMDhandler)
B747CMD_fuel_overd_pump_aft_2 			= create_command("laminar/B747/button_switch/fuel_overd_pump_aft_2", "Fuel Override Pump Aft 2", B747_fuel_overd_pump_aft_2_CMDhandler)
B747CMD_fuel_overd_pump_aft_3 			= create_command("laminar/B747/button_switch/fuel_overd_pump_aft_3", "Fuel Override Pump Aft 3", B747_fuel_overd_pump_aft_3_CMDhandler)

-- ANTI-ICE
B747CMD_anti_ice_nacelle_1 				= create_command("laminar/B747/button_switch/anti_ice_nacelle_1", "Anti-Ice Nacelle 1", B747_anti_ice_nacelle_1_CMDhandler)
B747CMD_anti_ice_nacelle_2 				= create_command("laminar/B747/button_switch/anti_ice_nacelle_2", "Anti-Ice Nacelle 2", B747_anti_ice_nacelle_2_CMDhandler)
B747CMD_anti_ice_nacelle_3 				= create_command("laminar/B747/button_switch/anti_ice_nacelle_3", "Anti-Ice Nacelle 3", B747_anti_ice_nacelle_3_CMDhandler)
B747CMD_anti_ice_nacelle_4 				= create_command("laminar/B747/button_switch/anti_ice_nacelle_4", "Anti-Ice Nacelle 4", B747_anti_ice_nacelle_4_CMDhandler)
B747CMD_anti_ice_wing 					= create_command("laminar/B747/button_switch/anti_ice_wing", "Anti-Ice Wing", B747_anti_ice_wing_CMDhandler)
B747CMD_anti_ice_window_L 				= create_command("laminar/B747/button_switch/anti_ice_window_L", "Anti-Ice Winodw L", B747_anti_ice_window_L_CMDhandler)
B747CMD_anti_ice_window_R 				= create_command("laminar/B747/button_switch/anti_ice_window_R", "Anti-Ice Winodw L", B747_anti_ice_window_R_CMDhandler)

-- BLEED AIR
B747CMD_bleed_air_isln_vlv_L 			= create_command("laminar/B747/button_switch/bleed_air_isln_vlv_L", "Bleed Air Isolation Valve L", B747_bleed_air_isln_vlv_L_CMDhandler)
B747CMD_bleed_air_isln_vlv_R 			= create_command("laminar/B747/button_switch/bleed_air_isln_vlv_R", "Bleed Air Isolation Valve R", B747_bleed_air_isln_vlv_R_CMDhandler)
B747CMD_bleed_air_vlv_engine_1 			= create_command("laminar/B747/button_switch/bleed_air_vlv_engine_1", "Bleed Air Valve Engine 1", B747_bleed_air_vlv_engine_1_CMDhandler)
B747CMD_bleed_air_vlv_engine_2 			= create_command("laminar/B747/button_switch/bleed_air_vlv_engine_2", "Bleed Air Valve Engine 2", B747_bleed_air_vlv_engine_2_CMDhandler)
B747CMD_bleed_air_vlv_engine_3 			= create_command("laminar/B747/button_switch/bleed_air_vlv_engine_3", "Bleed Air Valve Engine 3", B747_bleed_air_vlv_engine_3_CMDhandler)
B747CMD_bleed_air_vlv_engine_4 			= create_command("laminar/B747/button_switch/bleed_air_vlv_engine_4", "Bleed Air Valve Engine 4", B747_bleed_air_vlv_engine_4_CMDhandler)
B747CMD_bleed_air_vlv_apu 				= create_command("laminar/B747/button_switch/bleed_air_vlv_apu", "Bleed Air Valve APU", B747_bleed_air_vlv_apu_CMDhandler)

-- YAW DAMPER
B747CMD_yaw_damper_upr 					= create_command("laminar/B747/button_switch/yaw_damper_upr", "Yaw Damper Upper", B747_yaw_damper_upr_CMDhandler)
B747CMD_yaw_damper_lwr 					= create_command("laminar/B747/button_switch/yaw_damper_lwr", "Yaw Damper Lower", B747_yaw_damper_lwr_CMDhandler)

-- CARGO FIRE
B747CMD_cargo_fire_arm_fwd 				= create_command("laminar/B747/button_switch/cargo_fire_arm_fwd", "Cargo Fire Arm Forward", B747_cargo_fire_arm_fwd_CMDhandler)
B747CMD_cargo_fire_arm_aft 				= create_command("laminar/B747/button_switch/cargo_fire_arm_aft", "Cargo Fire Arm Aft", B747_cargo_fire_arm_aft_CMDhandler)
B747CMD_cargo_fire_disch 				= create_command("laminar/B747/button_switch/cargo_fire_disch", "Cargo Fire Discharge", B747_cargo_fire_disch_CMDhandler)
...
B747CMD_obsrv_audio_switch_left 		= create_command("laminar/B747/toggle_switch/observer_audio_left", "Observer Audio Switch Left", B747_obsrv_audio_switch_left_CMDhandler)
B747CMD_obsrv_audio_switch_right 		= create_command("laminar/B747/toggle_switch/observer_audio_right", "Observer Audio Switch Right", B747_obsrv_audio_switch_right_CMDhandler)

-- SERVICE INTERPHONE SWITCH
B747CMD_srvc_interphone_switch 			= create_command("laminar/B747/toggle_switch/srvc_interphone", "Service Interphone Switch", B747_srvc_interphone_switch_CMDhandler)

-- ENGINE START SWITCH
B747CMD_engine_start_switch1 			= create_command("laminar/B747/toggle_switch/engine_start1", "Engine Start Switch 1", B747_engine_start_switch1_CMDhandler)
B747CMD_engine_start_switch2 			= create_command("laminar/B747/toggle_switch/engine_start2", "Engine Start Switch 2", B747_engine_start_switch2_CMDhandler)
B747CMD_engine_start_switch3 			= create_command("laminar/B747/toggle_switch/engine_start3", "Engine Start Switch 3", B747_engine_start_switch3_CMDhandler)
B747CMD_engine_start_switch4 			= create_command("laminar/B747/toggle_switch/engine_start4", "Engine Start Switch 4", B747_engine_start_switch4_CMDhandler)
		
B747CMD_engine_start_switch1_off 		= create_command("laminar/B747/toggle_switch/engine_start1_off", "Engine Start Switch 1 Off", B747_engine_start_switch1_off_CMDhandler)
B747CMD_engine_start_switch2_off 		= create_command("laminar/B747/toggle_switch/engine_start2_off", "Engine Start Switch 2 Off", B747_engine_start_switch2_off_CMDhandler)
B747CMD_engine_start_switch3_off 		= create_command("laminar/B747/toggle_switch/engine_start3_off", "Engine Start Switch 3 Off", B747_engine_start_switch3_off_CMDhandler)
B747CMD_engine_start_switch4_off 		= create_command("laminar/B747/toggle_switch/engine_start4_off", "Engine Start Switch 4 Off", B747_engine_start_switch4_off_CMDhandler)

-- WINDHSIELD WASHER SWITCH
B747CMD_windshield_washer_switch_L 		= create_command("laminar/B747/toggle_switch/windshield_washer_L", "Windshield Washer Switch Left", B747_windshield_washer_switch_L_CMDhandler)
B747CMD_windshield_washer_switch_R 		= create_command("laminar/B747/toggle_switch/windshield_washer_R", "Windshield Washer Switch Right", B747_windshield_washer_switch_R_CMDhandler)

-- OUTFLOW VALVE OPEN/CLOSE SWITCH
B747CMD_outflow_valve_switch_open 		= create_command("laminar/B747/toggle_switch/outflow_valve_open", "Outlfow Valve Switch Open", B747_outflow_valve_switch_open_CMDhandler)
B747CMD_outflow_valve_switch_close 		= create_command("laminar/B747/toggle_switch/outflow_valve_close", "Outlfow Valve Switch Close", B747_outflow_valve_switch_close_CMDhandler)

-- STORM LIGHT SWITCH
B747CMD_storm_light_switch 				= create_command("laminar/B747/toggle_switch/storm_light", "Storm Light Switch", B747_storm_light_switch_CMDhandler)

-- LANDING LIGHT SWITCH
B747CMD_landing_light_switch_OBL 		= create_command("laminar/B747/toggle_switch/landing_light_OBL", "Landing Light Switch Outboard Left", B747_landing_light_switch_OBL_CMDhandler)
B747CMD_landing_light_switch_OBR 		= create_command("laminar/B747/toggle_switch/landing_light_OBR", "Landing Light Switch Outboard Right", B747_landing_light_switch_OBR_CMDhandler)
B747CMD_landing_light_switch_IBL 		= create_command("laminar/B747/toggle_switch/landing_light_IBL", "Landing Light Switch Inboard Left", B747_landing_light_switch_IBL_CMDhandler)
B747CMD_landing_light_switch_IBR 		= create_command("laminar/B747/toggle_switch/landing_light_IBR", "Landing Light Switch Inboard Right", B747_landing_light_switch_IBR_CMDhandler)

-- RUNWAY TURNOFF LIGHTS
B747CMD_runway_turnoff_light_switch_L 	= create_command("laminar/B747/toggle_switch/rwy_tunoff_L", "Left Runway Turnoff Light Switch", B747_runway_turnoff_light_switch_L_CMDhandler)
B747CMD_runway_turnoff_light_switch_R 	= create_command("laminar/B747/toggle_switch/rwy_tunoff_R", "Right Runway Turnoff Light Switch", B747_runway_turnoff_light_switch_R_CMDhandler)

-- TAXI LIGHT SWITCH
B747CMD_taxi_light_switch 				= create_command("laminar/B747/toggle_switch/taxi_light", "Taxi Light Switch", B747_taxi_light_switch_CMDhandler)

-- BEACON LIGHT SWITCH
B747CMD_beacon_light_switch_up 			= create_command("laminar/B747/toggle_switch/beacon_light_up", "Beacon Light Switch Up", B747_beacon_light_switch_up_CMDhandler)
B747CMD_beacon_light_switch_down 		= create_command("laminar/B747/toggle_switch/beacon_light_down", "Beacon Light Switch Down", B747_beacon_light_switch_down_CMDhandler)

-- NAV LIGHT SWITCH
B747CMD_nav_light_switch 				= create_command("laminar/B747/toggle_switch/nav_light", "Nav Light Switch", B747_nav_light_switch_CMDhandler)

-- STROBE LIGHT SWITCH
B747CMD_strobe_light_switch 			= create_command("laminar/B747/toggle_switch/strobe_light", "Strobe Light Switch", B747_strobe_light_switch_CMDhandler)

-- WING LIGHT SWITCH
B747CMD_wing_light_switch 				= create_command("laminar/B747/toggle_switch/wing_light", "Wing Light Switch", B747_wing_light_switch_CMDhandler)

-- LOGO LIGHT SWITCH
B747CMD_logo_light_switch 				= create_command("laminar/B747/toggle_switch/logo_light", "Logo Light Switch", B747_logo_light_switch_CMDhandler)

-- IND LIGHT SIWTCH
B747CMD_ind_light_switch_up 			= create_command("laminar/B747/toggle_switch/ind_light_up", "Ind Light Switch Up", B747_ind_light_switch_up_CMDhandler)
B747CMD_ind_light_switch_down 			= create_command("laminar/B747/toggle_switch/ind_light_down", "Ind Light Switch Down", B747_ind_light_switch_down_CMDhandler)
...
-- VOR/ADF SWITCH
B747CMD_vor_adf_pilot_switch_L_up 		= create_command("laminar/B747/toggle_switch/vor_adf_pilot_L_up", "VOR/ADF Switch Pilot Left Up", B747_vor_adf_pilot_switch_L_up_CMDhandler)
B747CMD_vor_adf_pilot_switch_L_down 	= create_command("laminar/B747/toggle_switch/vor_adf_pilot_L_down", "VOR/ADF Switch Pilot Left Down", B747_vor_adf_pilot_switch_L_down_CMDhandler)

B747CMD_vor_adf_pilot_switch_R_up 		= create_command("laminar/B747/toggle_switch/vor_adf_pilot_R_up", "VOR/ADF Switch Pilot Right Up", B747_vor_adf_pilot_switch_R_up_CMDhandler)
B747CMD_vor_adf_pilot_switch_R_down 	= create_command("laminar/B747/toggle_switch/vor_adf_pilot_R_down", "VOR/ADF Switch Pilot Right Down", B747_vor_adf_pilot_switch_R_down_CMDhandler)


B747CMD_vor_adf_fo_switch_L_up 			= create_command("laminar/B747/toggle_switch/vor_adf_fo_L_up", "VOR/ADF Switch First Officer Left Up", B747_vor_adf_fo_switch_L_up_CMDhandler)
B747CMD_vor_adf_fo_switch_L_down 		= create_command("laminar/B747/toggle_switch/vor_adf_fo_L_down", "VOR/ADF Switch First Officer Left Down", B747_vor_adf_fo_switch_L_down_CMDhandler)


B747CMD_vor_adf_fo_switch_R_up 			= create_command("laminar/B747/toggle_switch/vor_adf_fo_R_up", "VOR/ADF Switch First Officer Right Up", B747_vor_adf_fo_switch_R_up_CMDhandler)
B747CMD_vor_adf_fo_switch_R_down 		= create_command("laminar/B747/toggle_switch/vor_adf_fo_R_down", "VOR/ADF Switch First Officer Right Down", B747_vor_adf_fo_switch_R_down_CMDhandler)
...
B747CMD_flight_dir_switch_L 			= create_command("laminar/B747/toggle_switch/flight_dir_L", "Flight Director Switch Left", B747_flight_dir_switch_L_CMDhandler)
B747CMD_flight_dir_switch_R 			= create_command("laminar/B747/toggle_switch/flight_dir_R", "Flight Director Switch Right", B747_flight_dir_switch_R_CMDhandler)


-- AUTO-THROTTLE SWITCH
B747CMD_autothrottle_arm_switch 		= create_command("laminar/B747/toggle_switch/autothrottle", "Logo Light Switch", B747_autothrottle_arm_switch_CMDhandler)
B747CMD_autothrottle_arm            	= create_command("laminar/B747/authrottle_arm", "Autothrottle Arm", B747_autothrottle_arm_CMDhandler)
B747CMD_autothrottle_disarm         	= create_command("laminar/B747/authrottle_disarm", "Autothrottle Disarm", B747_autothrottle_disarm_CMDhandler)
...
B747CMD_heading_ref_switch 				= create_command("laminar/B747/toggle_switch/heading_ref", "heading Reference Switch", B747_heading_ref_switch_CMDhandler)
...
----- OVERHEAD SUN VISOR ----------------------------------------------------------------
B747CMD_sun_visor_up_down_capt  		= create_command("laminar/B747/toggle_sun_visor/up_down/capt", "number", B747_sun_visor_up_down_capt_CMDhandler)
B747CMD_sun_visor_up_down_fo    		= create_command("laminar/B747/toggle_sun_visor/up_down/fo", "number", B747_sun_visor_up_down_fo_CMDhandler)




----- WINDOW SUN SHADES -----------------------------------------------------------------
B747CMD_window_shade_up_down_front_capt = create_command("laminar/B747/window_shade/up_down_front/front_capt", "number", B747_window_shade_up_down_front_capt_CMDhandler)
B747CMD_window_shade_up_down_rear_capt  = create_command("laminar/B747/window_shade/up_down_rear/capt", "number", B747_window_shade_up_down_rear_capt_CMDhandler)

B747CMD_window_shade_up_down_front_fo  	= create_command("laminar/B747/window_shade/up_down_front/front_fo", "number", B747_window_shade_up_down_front_fo_CMDhandler)
B747CMD_window_shade_up_down_rear_fo  	= create_command("laminar/B747/window_shade/up_down_rear/fo", "number", B747_window_shade_up_down_rear_fo_CMDhandler)




----- AI --------------------------------------------------------------------------------
B747CMD_ai_manip_quick_start			= create_command("laminar/B747/ai/manip_quick_start", "number", B747_ai_manip_quick_start_CMDhandler)
