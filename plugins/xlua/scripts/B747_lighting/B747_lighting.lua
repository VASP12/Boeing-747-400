...
----- SPILL LIGHTS ----------------------------------------------------------------------
B747DR_spill_light_capt_panel_flood     = create_dataref("laminar/B747/light/spill/ratio/captain_panel", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_center_panel_flood   = create_dataref("laminar/B747/light/spill/ratio/center_panel", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_capt_map             = create_dataref("laminar/B747/light/spill/ratio/captain_map", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_capt_chart           = create_dataref("laminar/B747/light/spill/ratio/captain_chart", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_fo_panel_flood       = create_dataref("laminar/B747/light/spill/ratio/first_officer_panel", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_fo_map               = create_dataref("laminar/B747/light/spill/ratio/first_officer_map", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_fo_chart             = create_dataref("laminar/B747/light/spill/ratio/first_officer_chart", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_observer_map         = create_dataref("laminar/B747/light/spill/ratio/observer_map", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_mcp_flood            = create_dataref("laminar/B747/light/spill/ratio/mcp_panel", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
B747DR_spill_light_aisle_stand_flood    = create_dataref("laminar/B747/light/spill/ratio/aisle_stand", "array[" .. tostring(NUM_SPILL_LIGHT_INDICES) .. "]")
...
----- LIT -------------------------------------------------------------------------------
--B747DR_LIT_capt_panel_flood             = create_dataref("laminar/B747/light/LIT/capt_panel_flood", "number")
--B747DR_LIT_fo_panel_flood               = create_dataref("laminar/B747/light/LIT/fo_panel_flood", "number")



----- ANNUNCIATORS ----------------------------------------------------------------------
B747DR_annun_brightness_ratio           = create_dataref("laminar/B747/annunciator/brightness_ratio", "array[" .. tostring(NUM_ANNUN_LIGHTS) .. "]")
...
----- LIGHTING RHEOSTATS ----------------------------------------------------------------
B747DR_flood_light_rheo_capt_panel      = create_dataref("laminar/B747/light/flood/rheostat/captain_panel", "number", B747DR_flood_light_rheo_capt_panel_DRhandler)
B747DR_map_light_rheo_capt              = create_dataref("laminar/B747/light/map/rheostat/captain", "number", B747DR_map_light_rheo_capt_DRhandler)
B747DR_chart_light_rheo_capt            = create_dataref("laminar/B747/light/chart/rheostat/captain", "number", B747DR_chart_light_rheo_capt_DRhandler)
B747DR_flood_light_rheo_fo_panel        = create_dataref("laminar/B747/light/flood/rheostat/first_officer_panel", "number", B747DR_flood_light_rheo_fo_panel_DRhandler)
B747DR_map_light_rheo_fo                = create_dataref("laminar/B747/light/map/rheostat/first_officer", "number", B747DR_map_light_rheo_fo_DRhandler)
B747DR_chart_light_rheo_fo              = create_dataref("laminar/B747/light/chart/rheostat/first_officer", "number", B747DR_chart_light_rheo_fo_DRhandler)
B747DR_map_light_rheo_observer          = create_dataref("laminar/B747/light/map/rheostat/observer", "number", B747DR_map_light_rheo_observer_DRhandler)
B747DR_flood_light_rheo_mcp             = create_dataref("laminar/B747/light/flood/rheostat/mcp_panel", "number", B747DR_flood_light_rheo_mcp_DRhandler)
...
-- AI
B747CMD_ai_lighting_quick_start			= create_command("laminar/B747/ai/lighting_quick_start", "number", B747_ai_lighting_quick_start_CMDhandler)
...
function B747_annunciators()
    ...
    annun.b.ap_alt_hold = B747_ternary(simDR_autopilot_alt_hold_status == 2 and simDR_autopilot_fms_vnav_status < 1, 1, 0)
